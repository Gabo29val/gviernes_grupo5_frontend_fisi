...
class MainSearchFragment : Fragment(R.layout.fragment_main_search) {
    ...
    private fun setupSearchView() {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                query?.let {
                    val action =
                        MainSearchFragmentDirections.actionMainSearchFragmentToSearchedProductsFragment(
                            it
                        )
    ...
    private fun setupCategories() {
        ...
        loadImg(
            "https://patzcuaronoticias.com/wp-content/uploads/2020/04/%C2%BFCo%CC%81mo-solicitar-la-despensa-del-Plan-Alimentario-en-Michoaca%CC%81n.png",
            mBinding.category1.imgPhotoCategory
        )
        ...
        loadImg(
            "https://us.123rf.com/450wm/nikitos77/nikitos771204/nikitos77120400037/13431200-productos-l%C3%A1cteos-el-queso-y-los-huevos-sobre-un-fondo-blanco.jpg?ver=6",
            mBinding.category2.imgPhotoCategory
        )
        ...
        loadImg(
            "https://i.pinimg.com/originals/6d/b3/f2/6db3f2227c414ac2dba117d5a6f3af15.png",
            mBinding.category3.imgPhotoCategory
        )
